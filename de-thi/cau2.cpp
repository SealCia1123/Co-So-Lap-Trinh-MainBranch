// Viết chương trình cho phép tạo ngẫu nhiên một mảng số nguyên n phần tử (n
// được nhập
// từ bàn phím), các số trong mảng chỉ chứa các giá trị từ 20 – 40. (1 điểm)
// a) In các giá trị trong mảng ra màn hình, mỗi phần tử cách nhau một khoảng
// trắng (1 điểm) b) In ra màn hình số chẵn lớn nhất, nhỏ nhất trong mảng. (1,5
// điểm) c) Sắp xếp mảng theo thứ tự: các số lẻ nằm bên trái, các số chẵn nằm
// bên phải, dãy các số lẻ và các số chẵn đều có thứ tự tăng dần (lưu ý: không
// dùng mảng phụ). In mảng kết quả ra màn hình. (1,5 điểm)
#include <iostream>
#include <random>
using namespace std;
